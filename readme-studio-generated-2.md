...
<img width="1110" height="533" alt="image" src="https://github.com/user-attachments/assets/2eb4401d-dd7c-4934-a1db-828fa0172d69" />
...
**3.** Write a SQL statement that lists the total number of tickets purchased by customers who are from Tennessee. Order results by ascending price.

**4.** List the number of shows per venue that are happening in July.
